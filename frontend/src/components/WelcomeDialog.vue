      ...
      <q-card>
        ...
        <q-card-section>
          <div style="max-width: 550px">
            ...
            <div class="q-pt-sm">
              This is the frontend server deployed on Vercel. We have a pre-deployed low-performance backend server
              for you. You can download the backend source code (Python) and start the
...
export default {
  name: "WelcomeDialog",
  props: {
    // TODO: Use Vuex to ensure the communication between parent and child components
    welcomeDialogState: {
      // useless currently
      type: Boolean,
      default: true
  ...
  setup() {
    ...
    return { githubRepo, welcomeDialog }
  }
}
</script>
